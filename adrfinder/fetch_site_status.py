...
class perform_site_check():
    ...
    def run(self, uuid):
        ...
        base_link = 'https://www.disneyworld.co.uk/dining-reservation/setup-order/table-service/?offerId[]='
        ...
        if response.status != 200:
            ...
            print(">> Request url: https://www.disneyworld.co.uk{}".format(endpoint))
